/* VidroGestor — Service Worker (staging). Cache leve + offline shell.
   O banco é o Supabase (online). Offline cobre apenas o shell e a página offline. */
const CACHE = "vidrogestor-v1";
